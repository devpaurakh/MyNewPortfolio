...
const EducationExperience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: "I have designed the official websites for the Himalayan College of Engineering and The Federal Parliament of Nepal, developed a mobile app for the Parliament, and redesigned the entrance application web portal for Lumbini Technical University.",
      delay: 500
    },
    {
      company: "Freelancing",
      ...
      description: "While freelancing, I developed a tourism mobile application for Ratnanagar Municipality to promote local attractions and enhance visitor engagement.",
      delay: 1000
    }
  ];

  return (
    <div id='about' ref={sectionRef} className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <div className="absolute left-8 top-0 w-1 bg-gray-300 h-full">
                <div 
                  className={`w-full bg-orange-500 transition-all duration-2000 ease-out ${
                  ...
                  <div key={index} className="relative flex items-start">
                    ...
                    <div className="ml-16 w-full">
                      <div 
                        ...
                        style={{
                          transitionDelay: `${edu.delay + 200}ms`
                        }}
                      >
                  ...
                  <div key={index} className="relative flex items-start">
                    ...
                    <div className="ml-16 w-full">
                      <div 
                        ...
                        style={{
                          transitionDelay: `${exp.delay + 200}ms`
                        }}
                      >
                        <div className="flex justify-between items-start mb-3">
                          <h3 className="text-xl font-bold text-gray-800">
